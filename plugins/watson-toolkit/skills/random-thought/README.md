...
```bash
git clone https://github.com/jeremyknows/random-thought.git ~/.claude/skills/random-thought
```

**Other agents (Cursor, Windsurf, OpenClaw, etc.):**
```bash
git clone https://github.com/jeremyknows/random-thought.git /path/to/your/skills/random-thought
```
